...
5. Получение точного времени через NTP-сервер и выдача его CP/M программам.
6. Эмуляция контроллера клавиатуры на 580ВВ55. USB клавиатура подключается к PICO, нажатые клавиши эмулируются ответом ВВ55. Этот же механизм используется для эмуляции слотов MSX.
7. Эмуляция слотового механизма MSX. 
